 ...
 */
package com.android.pdfview.util.util;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.android.pdfview.util.api.ApiManager;
...
public class FileUtils {
     ...
     * @param fileUrl
     */
    public static void  fileFromLocalStorage(String fileUrl, final String fileName)throws IOException {
